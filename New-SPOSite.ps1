function New-SPOnlineSite {
    ...
    $SiteOwner = "yuriy.samorodov@veeam.com"
    ...
    $PnPOnline = @{
        ...
        #SkipTenantAdminCheck = $true #Not supported in PnP.PowerShell module
    ...
    $SetPnPSite = @{
        ...
        #DefaultLinkPermission = "RespectOrgSetting" #Respect the organization default sharing link permission
        #DefaultSharingLinkType = "RespectOrgSetting" #Respect the organization default sharing link type
    ...
    if ($ExternalSharing -ne 'Disabled') {    
        Connect-PnPOnline -Credentials $global:credentials -Url $PnPTenantSite.Url -ReturnConnection | Out-Null
        $PnPConnection = Get-PnPConnection
    ...
    $PnPConnection = Connect-PnPOnline -Credentials $global:credentials -Url $PnPTenantSite.Url -ReturnConnection
    ...
    #Add Users to groups
    Connect-AzureAD -Credential $global:credentials | out-Null
