foreach ( $site in $externalsitesNoBanner[1..21] ) {
    
    Connect-PnPOnline -Url $site.Url -Thumbprint 3bc79c67f5d68abbdae90760c57d4e8cd3b2ea12 -ClientId 15460790-5201-4749-ac72-7812b8d8bffd -Tenant ba07baab-431b-49ed-add7-cbc3542f5140 -TenantAdminUrl https://veeamsoftwarecorp-admin.sharepoint.com/
    ...
    $PnPCustomAction = @{
        ...
        ClientSideComponentProperties = "{""siteUrl"":""$($site.Url)"", ""listName"" : ""Announcements""}"
